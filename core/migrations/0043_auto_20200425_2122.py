...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='origen_gc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.OrigenGastosCorrientes', verbose_name=b'Origen Gasto de Corriente'),
        ),
    ]
