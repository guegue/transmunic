    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from=b'nombre', editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('codigo', models.CharField(max_length=25, serialize=False, primary_key=True)),
                ('nombre', models.CharField(max_length=200)),
                ('slug', autoslug.fields.AutoSlugField(populate_from=b'nombre', null=True, editable=False)),
