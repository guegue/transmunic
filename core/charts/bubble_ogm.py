...
def ogm_bubble_chart_data(municipio=None, year=None, portada=False):
    ...
    if municipio:
        ...
        ejecutado from (select id.asignado, id.ejecutado, id.gasto_id, \
        id.subsubtipogasto_id, i.municipio_id, i.periodo, i.anio, ssti.subtipogasto_id, ssti.origen_id \
        ...
        ejecutado, o.nombre, o.id from (select id.asignado, id.ejecutado, id.gasto_id, \
        id.subsubtipogasto_id, i.municipio_id, i.periodo, i.anio, ssti.subtipogasto_id, ssti.origen_id \
        from core_gastodetalle as id left join core_gasto as i on id.gasto_id = i.id \
        left join core_subsubtipogasto as ssti on id.subsubtipogasto_id=ssti.codigo \
        where i.anio = %s \
