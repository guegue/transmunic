...
from core.importer import UploadExcelView, IngresoDetailView, ReglonIngresosView
...
urlpatterns = [
    ...
    url(r'^reglon/ingresos/$', ReglonIngresosView.as_view()),
    url(r'^ingreso/(?P<pk>\d+)/$', IngresoDetailView.as_view(), name='ingreso-detail'),
