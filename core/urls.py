...
urlpatterns = patterns('',
    ...
    url(r'^inversion-categoria$', 'core.charts.misc.inversion_categoria_chart', name='inversion_categoria'),
    url(r'^gf$', 'core.charts.misc.gf_chart', name='gastos_funcion'),
    url(r'^gpersonal$', 'core.charts.misc.gpersonal_chart', name='gastos_personal'),
    url(r'^ago$', 'core.charts.misc.ago_chart', name='autonomia_gastos'),
    url(r'^aci$', 'core.charts.misc.aci_chart', name='ahorro_corriente'),
    url(r'^psd$', 'core.charts.misc.psd_chart', name='peso_deuda'),
    url(r'^ep$', 'core.charts.misc.ep_chart', name='ejecucion_presupuesto'),
